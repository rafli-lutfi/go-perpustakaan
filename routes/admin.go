...
func adminRoutes(router *gin.RouterGroup, handler APIHandler) {
	...
	buku.GET("/all", middleware.Auth, handler.BukuAPIHandler.GetAllBuku)
	...
	kategori.GET("/all", middleware.Auth, handler.KategoriHandler.GetAllKategori)
	...
	penerbit.GET("/all", middleware.Auth, handler.PenerbitHandler.GetAllPenerbit)
	...
	author.GET("/all", middleware.Auth, handler.AuthorHandler.GetAllAuthor)
